...
RSpec.describe TransferService, type: :service do
  ...
  describe '.transfer_by_email' do
    context 'with valid email' do
      it 'transfers money to user by email' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 150.0)

        expect(result[:success]).to be true
        expect(result[:transfer][:amount]).to eq(150.0)
        expect(result[:transfer][:to_user][:email]).to eq(to_user.email)
      ...
      it 'transfers money between users and creates transaction records' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 300.0)
      ...
      it 'creates correct transaction records for both users' do
        described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 250.0)
        ...
        expect(from_transaction.description).to eq("Transfer to #{to_user.email}")
      ...
      it 'uses custom description when provided' do
        described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 100.0, description: 'Payment for services')
      ...
      it 'handles decimal amounts correctly' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: '123.45')
      ...
      it 'allows transfer of entire balance' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 1000.0)
      ...
      it 'returns proper response structure' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 100.0)
      ...
      it 'handles case insensitive email lookup' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email.upcase, amount: 100.0)
    ...
    context 'with invalid parameters' do
      it 'returns error for insufficient funds' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 1500.0)
      ...
      it 'returns error for negative amount' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: -50.0)
      ...
      it 'returns error for zero amount' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 0)
      ...
      it 'returns error for nil amount' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: nil)
      ...
      it 'returns error for amount too large' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 2_000_000)
      ...
      it 'returns error for exact insufficient funds scenario' do
        result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 1000.01)
  ...
  describe 'integration scenarios' do
    it 'handles multiple transfers correctly' do
      result1 = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 200.0)
    ...
    it 'maintains audit trail across transfers' do
      described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 300.0)
    ...
    it 'handles transfer with existing balance operations' do
      ...
      result = described_class.transfer_by_email(from_user: from_user, to_email: to_user.email, amount: 600.0)
      expect(result[:success]).to be true
